    ...
    <div className="p-5 space-y-5 animate-fade-in">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <Link to="/campaigns" className="btn-ghost p-1.5">
          ...
          <div>
            <div className="flex items-center gap-2.5">
              ...
              {isSending && (
                <span className="flex items-center gap-1.5 text-[11px] text-brand-400 font-medium">
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <div className="space-y-4">
          ...
          <div className="card p-4">
            ...
            <p className="text-[13px] text-surface-300 leading-relaxed whitespace-pre-wrap">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {a && (
            <>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div key={label} className="card p-4 text-center">
                    ...
                    <p className="text-[11px] text-surface-500 mt-1">{label}</p>
                  </div>
                ))}
              </div>
              ...
              {/* Funnel Chart */}
              <div className="card p-4">
                <h3 className="section-title mb-3">Engagement Funnel</h3>
          ...
          {campaign.communications && campaign.communications.length > 0 && (
            <div className="card">
              <div className="px-4 py-3 border-b border-[#252d3e] flex items-center justify-between">
              ...
              <div className="overflow-x-auto max-h-72 overflow-y-auto">
                <table className="w-full">
                  <thead className="sticky top-0 bg-surface-900/90 backdrop-blur-sm z-10">
                    <tr className="border-b border-[#252d3e]">
                      {["Recipient", "Address", "Status", "Last Updated"].map(
                        (h) => (
                          <th
                            key={h}
                            className="text-left px-4 py-2.5 text-[11px] font-medium text-surface-500 uppercase tracking-wider"
                          >
                            {h}
                          </th>
                        ),
