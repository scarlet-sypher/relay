      ...
      <div className="card">
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            description="Create audience segments to target your campaigns"
          />
        ) : (
              ...
              >
                <div className="flex items-center gap-4 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="font-medium text-surface-100 group-hover:text-white truncate">
                      {s.name}
                    </p>
                ...
                <div className="flex items-center gap-6 shrink-0 ml-4">
                  <div className="text-right">
                    <div className="flex items-center gap-1.5 text-sm font-semibold text-surface-100">
